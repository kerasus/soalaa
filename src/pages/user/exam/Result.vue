  ...
  mounted() {
    ...
    examData.getUserExamWithCorrectAnswers(user_exam_id, exam_id)
        ...
        .then(() => {
          ...
          that.$store.commit('Auth/updateUserFirstName', examData.studentReport.user.first_name)
          that.$store.commit('Auth/updateUserLastName', examData.studentReport.user.last_name)
