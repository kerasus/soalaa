    ...
    <template v-slot:entity-crud-table-cell="{inputData}">
      <template v-if="inputData.col.name === 'actions'">
        <q-btn round
               ...
               color="info"
               icon="info"
               :to="{name:'Admin.QuestionReport.Show', params: {id: inputData.props.row.id}}">
          <q-tooltip>
            مشاهده
          </q-tooltip>
        </q-btn>
      ...
      allProps: {
        config: {
          ...
          title: {
            ...
            edit: 'ویرایش  خطای سوال',
            create: 'افزودن نوع خطا',
            index: 'لیست انواع خطاها'
          },
          showRouteName: 'Admin.QuestionReport.Show',
          editRouteName: 'Admin.QuestionReport.Edit',
          indexRouteName: 'Admin.QuestionReport.Index',
          createRouteName: 'Admin.QuestionReport.Create',
