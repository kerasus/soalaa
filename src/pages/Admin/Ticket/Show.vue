  ...
  data () {
    return {
      ...
      inputs: [
        ...
        { type: 'dateTime', name: 'created_at', responseKey: 'ticket.created_at', label: 'تاریخ ایجاد', calendarIcon: ' ', col: 'col-md-4', disable: true },
        ...
        { type: 'dateTime', name: 'created_at', responseKey: 'ticket.updated_at', calendarIcon: ' ', abc: true, label: 'تاریخ بروز آوری:', col: 'col-md-4', disable: true },
