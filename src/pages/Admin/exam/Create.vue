  ...
  data () {
    return {
      ...
      inputs: [
        ...
        { type: 'input', name: 'questionType', responseKey: 'data.questionType', label: 'نوع سوالات', col: 'col-md-3' },
        ...
        { type: 'dateTime', name: 'finish_at', responseKey: 'data.finish_at', label: ' زمان پایان آزمون', col: 'col-md-3' },
        { type: 'input', name: 'delay_time', responseKey: 'data.delay_time', label: 'زمان تاخیر(دقیقه)', col: 'col-md-3', value: 0 },
        { type: 'input', name: 'hellooooo', responseKey: 'data.hellooooo', label: 'مدت زمان آزمون(دقیقه)', col: 'col-md-3', value: 0 },
        {
          type: 'tiptapEditor',
          name: 'inputEditor',
          label: 'توضیحات آزمون',
        ...
        },
        {
          ...
          col: 'col-md-6',
          value: [
            { type: 'separator', label: 'تنظیمات آزمون', col: 'col-md-12' },
            { type: 'Checkbox', name: 'enable', responseKey: 'data.enable', label: 'آزمون فعال شود', col: 'col-md-6', value: false },
            { type: 'Checkbox', name: 'is_free', responseKey: 'data.is_free', label: 'آزمون رایگان شود', col: 'col-md-6', value: false },
            { type: 'Checkbox', name: 'generate_questions_automatically', responseKey: 'data.generate_questions_automatically', label: 'تولید اتوماتیک سوال', col: 'col-md-6', value: false },
            { type: 'Checkbox', name: 'confirm', responseKey: 'data.confirm', label: 'تولید اتوماتیک کارنامه', col: 'col-md-6', value: false },
            { type: 'Checkbox', name: 'is_register_open', responseKey: 'data.is_register_open', label: 'ثبت نام آزمون باز است.', col: 'col-md-6', value: false },
            { type: 'Checkbox', name: 'is_open', responseKey: 'data.is_open', label: 'شرکت در آزمون باز است', col: 'col-md-6', value: false },
            { type: 'Checkbox', name: 'remember_exam', responseKey: 'data.remember_exam', label: 'پیامک یادآوری آزمون برای مخاطبین', col: 'col-md-6', value: false },
            { type: 'Checkbox', name: 'sms-link', responseKey: 'data.sms-link', label: 'پیامک لینک آزمون برای مخاطبین', col: 'col-md-6', value: false }
          ]
        },
