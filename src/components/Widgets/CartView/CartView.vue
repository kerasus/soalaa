  ...
  <div class="cart-items-container">
    <div class="cart-items">
      <q-card class="cart-card">
        <div class="image"></div>
        <div class="content">
          <div class="title">آزمـون مرحله سوم سه‌آ</div>
          <div class="desc-container">
            <div class="item">
              <div class="icon-spacing icon-teacher"></div>
              <div class="desc">گروه آموزشی آلاء</div>
            </div>
            <div class="item">
              <div class="icon-spacing icon-book"></div>
              <div class="desc">رشته تحصیلی: ریاضی - تجربی</div>
            </div>
            <div class="item">
              <div class="icon-spacing icon-menu-board"></div>
              <div class="desc">تاریخ آزمون : 23 مرداد</div>
            </div>
          </div>
          <div class="price-container">
            <div class="discount">۲۰٪</div>
            <div class="previous">۹۷۰,۰۰۰</div>
            <div class="current">۹۷۰,۰۰۰</div>
