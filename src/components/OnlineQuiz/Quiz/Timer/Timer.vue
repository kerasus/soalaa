<template>
    <div style="margin-bottom: 0px;width: 100%">
        ...
        <div v-if="mob" class="sideBtns ml-5">
            ...
            <span style="margin-right: 50px;height:40px">|</span>
        ...
        <div v-if="!mob" class="timeCArd " id="test">
            ...
            <v-row>
                ...
                <v-col v-if="show" cols="3" style="margin-top: 30px">
                    زمان گذشته:
                    <span style="margin-right: 10px">
                        {{ seconds}} : {{ minutes}} : {{hours}}
                    </span>
                </v-col>
                <v-col v-if="show" cols="7" class="text-center" style="margin-top: 30px">
        ...
        <mobile-timer v-if="windowSize < 800" />
        <pc-timer v-else/>
