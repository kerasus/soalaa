<template>
    <div>
        <div  class="timeCArdMob" @click="drawerUp" id="clockBtn">
        ...
        <div
             class="right-drawer"
             :style="{height: drawerVisible ? '90px' : '0'}"
        >
...
<style scoped>
    .remainingTimeText{
        font-size: 0.5em;margin-right: 10px
    }
    .passedTimeText{
        font-size: 0.6em;margin-right: 10px;width: 60%;margin-left: 10px
    }
    .timerInfo{
        padding-top: 10px;padding-bottom: 10px;width: 200px
    }
    .closeIcon{
        float: left;
