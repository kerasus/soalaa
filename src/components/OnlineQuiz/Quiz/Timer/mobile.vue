    ...
    <v-row class="d-flex justify-center">
        <v-col cols="10">
            <div class="d-flex justify-center">
                <div  class="sideBtns ml-4 elevation-3">
                    <v-row>
                        <v-col cols="1"/>
                ...
                <div
                        class="right-drawer elevation-3"
                ...
                <div  class="timeCArdMob d-flex justify-center elevation-3" @click="drawerUp" id="clockBtn" style="float:left;">
