<template>
  <div>
    <div class="row">
      <div class="col-12 col-sm-9 flex btnCol">
        <div class="sideBtns shadow-3">
          <div class="row">
            <div class="col flex justify-center">
              <q-btn :style="{ 'width':'150px','height': '20px' }"
                     flat
                     class="sideBtnIcons"
      ...
      <div class="col-sm-3 col-3 timerCol">
        <div id="clockBtn"
             ...
             style="float:left;"
             @click="drawerUp">
          <svg class="timerMob  justify-center"
    ...
    <div class="drawer shadow-13 flex justify-center "
      ...
      <div>
        ...
        <p v-if="remainingTime && currentCat"
