  ...
  <v-row>
    ...
    >
      <vue-tiptap-katex
        ref="tiptap"
        :loading="loading"
        :options="{ bubbleMenu: false, floatingMenu: false, poem: true, reading: true, persianKeyboard: true, onResizeEnd: onResizeEnd ,mathliveOptions: { smartFence: false }, uploadServer: { url: imageUrl, instantUpload: true, headers: { Authorization: 'Bearer ' + $store.getters['Auth/accessToken'] } } }"
      />
    </v-col>
